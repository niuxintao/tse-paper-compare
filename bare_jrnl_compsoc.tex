...
For a test case of which we want to identify the MFSs, say test case A,  if we change one factor of it to generate a new test case, say test Case B.  And assume that we introduce a new failure-inducing schema, but meanwhile we didn't break the original failure-inducing schema in the previous test case.
