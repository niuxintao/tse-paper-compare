...
Some parameters of these algorithm are assigned: for SP, the degree of MFSs we set is 4(we need change 2 later ), for CTA,the confidence factor of classified tree algorithm is 0.25 as same as [].
