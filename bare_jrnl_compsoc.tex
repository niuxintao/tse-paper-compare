...
\end{table*}
 ...
 We will also record the "recall" and "precise" for each voting combination. We just want to know, whether there exist some voting combination can have a advantage over all the algorithms consists it. And if so, how much promotion is the voting combination got compared to the best of the combination algorithms. The result is show in two facts: if it has a promotion over all the algorithms,  .
 \subsubsection{result and analysis}
 \begin{table*}\renewcommand{\arraystretch}{1.3}
