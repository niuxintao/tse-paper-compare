...
1)The result of the experiment 1 is depicted in figure \ref{fig_single}. There are something that is strictly clear that for algorithm AIFL, CTA, OFOT,LG there additional configurations is the same with the change of MFS, others are changed. 
