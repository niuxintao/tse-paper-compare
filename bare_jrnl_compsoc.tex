...
4)The data depicted in figure \ref{fig_free_k} shows that the average configurations needed of each algorithm for experiment 4. In this figure, the y-axis still reports the number of configurations while the x-axis represent a set of SUTs with the same number of configurations. These number of parameters are 8, 9, 10, 12, 15, 20, 30, 40, 60, 80, 100 and 120 respectively. And a point of a algorithm in this figure indicate the average number of configurations needed to identiying the MFS in that SUT with the same k.
...
we will enlarge some of them to figure \ref{fig_free_k_small}
...
5)Figure \ref{fig_free_d} gives us the result of the last experiment.
